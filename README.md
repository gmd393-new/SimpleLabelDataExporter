...
> **Note**: This app has been customized to use PostgreSQL in all environments (development, staging, production). See [DEVELOPMENT.md](./DEVELOPMENT.md) for setup instructions.
